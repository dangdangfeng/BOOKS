...
关于更多的Objective-C的编码规范，可以通过以下文档查找：

* [Apple Coding Guidelines for Cocoa](https://developer.apple.com/library/mac/documentation/Cocoa/Conceptual/CodingGuidelines/CodingGuidelines.html)
...
所有属性特性应该显式地列出来，有助于新手阅读代码。属性特性的顺序应该是atomicity、storage，逗号后用一个空格分割。
